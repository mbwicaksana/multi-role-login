              ...
              >
                ...
                <div className="flex items-center justify-between">
                  <NavLink
                    to="/users"
                    type="button"
                    className="inline-block mx-auto px-20 rounded-lg bg-red-500 py-3 text-sm font-medium text-white hover:bg-red-400"
                  >
                    Cancel
                  </NavLink>
                  <button
                    type="submit"
                    className="inline-block mx-auto px-20 rounded-lg bg-blue-500 py-3 text-sm font-medium text-white hover:bg-blue-400"
                  >
                    Add
                  </button>
                </div>
